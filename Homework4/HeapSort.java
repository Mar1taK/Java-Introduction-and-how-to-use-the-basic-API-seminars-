...
public class HeapSort {
    ...
    private static int LeftNumber(int i) {
    return (2 * i + 1);
    }

    private static int RightNumber(int i) {
    return (2 * i + 2);
    }
    ...
    int left = LeftNumber(i);
    int right = RightNumber(i);
    int largest = i;
    ...
    int[] sortArr = {115, 1025, 63, 0, 15, 3, 87, 145};
    heapSort(sortArr);
